      ...
      >
        <div className="glass rounded-3xl p-8 sm:p-10" style={{ border: '1px solid var(--border)' }}>
          <div className="text-center mb-8">
            ...
            <p className="text-xs tracking-editorial uppercase" style={{ color: 'var(--text-muted)' }}>Log in to manage your bookings</p>
          </div>
          ...
          <form action={action} className="space-y-4">
            <InputField name="email" type="email" label="Email" placeholder="you@example.com" />
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link href="/signup" className="font-semibold hover:text-white transition-colors" style={{ color: 'var(--gold)' }}>
              Sign up free
            </Link>
          </p>
        </div>
